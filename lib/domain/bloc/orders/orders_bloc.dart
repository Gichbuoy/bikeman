...
class OrdersBloc extends Bloc<OrdersEvent, OrdersState> {
  ...
  Future<void> _onAddNewOrders(
    ...
    try {
      ...
      final resp = await ordersServices.addNewOrders(
  ...
  Future<void> _onUpdateStatusOrderToDispatched(
    ...
    try {
      ...
      final resp = await ordersServices.updateStatusOrderToDispatched(
  ...
  Future<void> _onUpdateStatusOrderOnWay(
    ...
    try {
      ...
      final resp = await ordersServices.updateOrderStatusOnWay(
          event.idOrder,
  ...
  Future<void> _onUpdateStatusOrderDelivered(
    ...
    try {
      ...
      final resp =
          await ordersServices.updateOrderStatusDelivered(event.idOrder);
