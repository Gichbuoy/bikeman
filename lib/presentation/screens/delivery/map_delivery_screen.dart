...
import 'package:bikeman/presentation/screens/delivery/delivery_home_screen.dart';
        ...
        if (state is LoadingOrderState) {
          ...
          modalSuccess(
              ...
              () => Navigator.pushAndRemoveUntil(context,
                  routeFrave(page: OrderDeliveredScreen()), (route) => false));
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: NetworkImage(
                            '${Environment.endpointBase}${order.clientImage}'))),
              ),
